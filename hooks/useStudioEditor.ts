...
export function useStudioEditor(baseImage?: string, initialState?: Scene | null) {
    const {
        scene,
        initScene,
        loadScene,
    ...
    }, [baseImage, initialState, initialized, loadScene, initScene, setPan, setZoom]);
    ...
    }, [selectedId, panningMode, dispatch, redo, undo, setSelectedId, setPanningMode]);
