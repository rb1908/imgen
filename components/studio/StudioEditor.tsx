...
import { SocialEditorTools } from '../social/SocialEditorTools';
import { SocialEditorToolbar } from '../social/SocialEditorToolbar';
import { SidebarPanels } from '../social/editor/SidebarPanels';
import { TopToolbar } from '../social/editor/TopToolbar';
import { SocialCanvas } from '../social/editor/SocialCanvas';
...
export function StudioEditor({ baseImage, initialState, onSave, isSaving }: StudioEditorProps) {
    const {
        ...
        handleObjectDragEnd,
        handleTransformEnd
    } = useStudioEditor(baseImage, initialState);
